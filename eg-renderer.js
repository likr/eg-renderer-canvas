...
/***/ function(module, exports, __webpack_require__) {
	...
	var renderType = function renderType(layout) {
	  switch (layout) {
	    case 'arc':
	      return ['circle', 'arc'];
	    case 'circular':
	  ...
	  _createClass(EgRenderer, [{
	    ...
	    value: function createdCallback() {
	      ...
	      var render = function render() {
	        var now = new Date();
	        var transitionDuration = _this2.getAttribute('transition-duration');
	        var r = (now - p.layoutTime) / transitionDuration;
	        ...
	        try {
	          for (var _iterator = data.vertices[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	        ...
	        try {
	          for (var _iterator2 = data.vertices[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	            var _vertex = _step2.value;

	            var _u = _vertex.u;
	            for (var v in layout.edges[_u]) {
	              if (layout.edges[_u][v]) {
	                (0, _render.renderEdge)(ctx, layout.edges[_u][v]);
	              }
	            }
	          }
	        } catch (err) {
	    ...
	    value: function layout() {
	      ...
	      var mode = this.getAttribute('layout');
	      ...
	      try {
	        for (var _iterator3 = data.vertices[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	      ...
	      try {
	        for (var _iterator4 = data.edges[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
	      ...
	      var _renderType = renderType(this.getAttribute('layout')),
	          _renderType2 = _slicedToArray(_renderType, 1),
	          vertexType = _renderType2[0];
	      ...
	      try {
	        for (var _iterator6 = graph.vertices()[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
	          var u = _step6.value;
	    ...
	    value: function center() {
	      var _privates$get = privates.get(this),
	          ...
	          layoutResult = _privates$get.layoutResult,
	          margin = _privates$get.margin,
	          zoom = _privates$get.zoom;
...
/***/ function(module, exports) {
	...
	var renderVertex = exports.renderVertex = function renderVertex(ctx, args) {
	  switch (args.type) {
	    case 'circle':
	...
	var renderEdge = exports.renderEdge = function renderEdge(ctx, _ref) {
